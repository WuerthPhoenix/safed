...
if [ -f ${SYSTEMD_DIR}/${SERVICE} ];then
    ...
    if [ $? -eq 0 ]; then
    	...
    	rm ${RCPARENTDIR}/rc0.d/K${KSEQ}safed 2>/dev/null
    	rm ${RCPARENTDIR}/rc1.d/K${KSEQ}safed 2>/dev/null
    	rm ${RCPARENTDIR}/rc2.d/S${SSEQ}safed 2>/dev/null
    	rm ${RCPARENTDIR}/rc3.d/S${SSEQ}safed 2>/dev/null
    	rm ${RCPARENTDIR}/rc4.d/S${SSEQ}safed 2>/dev/null
    	rm ${RCPARENTDIR}/rc5.d/S${SSEQ}safed 2>/dev/null
    	rm ${RCPARENTDIR}/rc6.d/K${KSEQ}safed 2>/dev/null
    fi
